    ...
    $.fn.toc = function(options) {
        ...
        headers
            ...
            .each(function(_, header) {
                ...
                if (settings.maxLevel !== null && (this_level - highest_level > settings.maxLevel - 1)) {
                  // do nothing, max level reached
                } else if (this_level === level) {
                  // same level as before; same indenting
                  html += "<li class=\"" + settings.classes.item + " lvl-" + this_level + "\">" + createLink(header);
                    ...
                    for (i = this_level; i > level; i--) {
                        html += "<" + settings.listType + " class=\"" + settings.classes.list + " lvl-" + this_level + "\">" + "<li class=\"" + settings.classes.item + " lvl-" + this_level + "\">"
                    }
