...
![Continuous Delivery and Integration Overview](attachments/cicd-overview.png)
...
![CICD Mapping](attachments/cicd-mapping.png)
...
![CICD Jenkins](attachments/cicd-jenkins-docker.png)
