...
Mendix provides DevOps tools out of the box for continuous integration and continuous delivery (CI/CD), test automation, and monitoring (among other services) so that your development teams can embrace the DevOps way of working. Your teams can rapidly build, test, release, and maintain applications in production environments more autonomously with Mendix while they ensure compliance with your enterprise requirements. They can also use the Platform APIs to support direct integration with your existing CI/CD pipeline.
