...
For more information on how to start building you own set of UI resources, see the [Atlas UI](https://docs.mendix.com/front-end/atlasui/) how-to's in the Mendix documentation.
